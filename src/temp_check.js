...
Equipe BluePartner`;
    ...
    function renderDashboard(dash){
      ...
      const mClientesErroValidacao = document.getElementById('mClientesErroValidacao');
      if (mClientesErroValidacao) {
        mClientesErroValidacao.textContent = dash?.clientesComErroValidacao ?? '--';
      }
